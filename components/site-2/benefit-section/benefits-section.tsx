    ...
    "
      ...
      "
            >
                ...
                <div className="overflow-hidden rounded-[22px] w-[calc(100%-16px)] h-[calc(100vh-16px)] p-4 overflow-hidden sticky top-2 left-2">
                    ...
                    {/* Categories */}
                    <div className="absolute left-6 top-6 lg:left-8 lg:top-8 z-10 flex flex-col text-[50px] lg:text-[45px] 2xl:text-[68px] space-y-10 2xl:space-y-8">
      ...
      `}
              ...
              "
                                ...
                                {
                                    index !== data.benefits.length - 1 && <div className="px-10">
