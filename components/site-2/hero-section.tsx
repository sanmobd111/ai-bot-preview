        ...
        <section className="p-2 h-screen lg:h-[120vh] xl:h-screen box-border">
            <div className="relative bg-black text-white  rounded-2xl overflow-hidden h-full">
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center -translate-y-[4%]">
                    <h1
                        className="max-w-6xl text-[45px] feature-display font-normal leading-[1]  md:text-5xl xl:text-7xl 2xl:text-[100px]"
                        dangerouslySetInnerHTML={{ __html: data?.title }}
                    />

                    <p className="mt-6 lg:mt-8 2xl:mt-10 max-w-2xl xl:max-w-3xl 2xl:max-w-4xl text-base leading-relaxed text-gray-200 sm:text-lg md:text-xl lg:text-xl 2xl:text-[20px]">
                        {data?.subtitle}
                    </p>
